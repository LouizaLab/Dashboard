...
class HypothesisRun(models.Model):
    ...
    mode = models.CharField(max_length=10, choices=[('gpt', 'GPT'), ('mock', 'Mock')], default='mock')
...
class SurveyResponse(models.Model):
    ...
    agent = models.ForeignKey(PersonaAgent, on_delete=models.CASCADE, related_name='survey_responses')
