    ...
    def _create_agents(self, count):
        ...
        for i in range(count):
            ...
            system_prompt = self._generate_system_prompt(
                display_name, archetype, age_bucket, gender, region, income, behavior_params
            )
...
You're participating in conversations about fast-food preferences, behaviors, and choices. Answer questions authentically from your persona's perspective, drawing on your archetype traits and personal background."""
    ...
    def _generate_biography(self, name, archetype, age, region):
        ...
        return archetype_bios.get(
            archetype, f"{name} is a typical fast-food consumer from {region}."
        )
    ...
    def _create_survey_questions(self):
        ...
        questions_data = [
            ...
            {"text": "Describe your ideal fast-food meal.", "type": "open", "choices": []},
            {
            ...
            {"text": "What frustrates you most about fast food?", "type": "open", "choices": []},
            {
    ...
    def _create_evidence_data(self):
        ...
        for i in range(200):
            ...
            datum, was_created = EvidenceSurveyDatum.objects.get_or_create(
                ...
                date=evidence_date,
                defaults={
                    "dataset_name": f"Fast-Food Consumer Survey {evidence_date.year}",  # Dynamic year based on date
                    "archetype": archetype,
