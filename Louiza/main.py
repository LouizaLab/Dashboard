"""
Main entry point for Phase 1 and Phase 2
"""
...
def main():
    parser = argparse.ArgumentParser(description='Phase 1 & 2: Taste Embedding Model & Behavioral Dynamic Engine')
    ...
    if args.mode == 'simulate_phase3' or args.mode == 'all_phases':
        ...
        print("=" * 60)
        phase2_path = 'checkpoints_phase2/best_model_phase2.pt'
    ...
    if args.mode == 'phase4' or args.mode == 'all_phases':
        ...
        if not os.path.exists(sim_data_path):
            ...
            print("Please run Phase 3 simulation first.")
        else:
            ...
            run_phase4(
                ...
                output_dir=args.phase4_output_dir,
