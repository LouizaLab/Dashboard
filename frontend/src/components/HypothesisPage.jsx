  ...
  return (
    <div className="flex flex-1 overflow-hidden relative">
      ...
      <div className="flex-1 flex flex-col relative">
        ...
        {results && (
          <div className="absolute bottom-6 left-6 right-6 max-w-4xl mx-auto z-20 pointer-events-none">
            <div className="bg-dark-surface/95 backdrop-blur-sm border border-dark-border rounded-xl p-6 shadow-xl pointer-events-auto max-h-96 overflow-y-auto">
              <ResultsPanel
                results={results}
