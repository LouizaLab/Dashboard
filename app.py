...
st.markdown("""
    ...
    * {
    ...
    /* Hide ALL tooltips showing keys and help text */
    ...
    /* Prevent any tooltip from showing on hover - comprehensive */
    *:hover [data-baseweb="tooltip"],
    *:hover [data-baseweb="popover"],
    *:hover [role="tooltip"],
    *:hover .stTooltip,
    [data-baseweb="base-input"]:hover [data-baseweb="tooltip"],
    [data-baseweb="select"]:hover [data-baseweb="tooltip"],
...
with col_title1:
    st.title("Behavioral Simulation Data")
...
with tab1:
    if not selected_segments:
        ...
        if not taste_profile.empty:
            ...
            st.markdown("Average intent values showing how much each segment is engaging with coffee, sugar, and price, and to what level of engagement they have (0 = low, 1 = high engagement).")
            ...
            st.markdown("Radar chart showing how different user segments respond to sugar preference, caffeine tolerance, price sensitivity, and average intent.")
    ...
    if not selected_segments:
        ...
        if trajectories.empty:
            ...
            if not dynamics.empty:
                ...
                st.markdown("Key behavioral indicators including repeat rate, churn rate, adoption rate, and intent value over time.")
                ...
                st.markdown("Heatmap showing how different segments respond across various contexts.")
...
with tab3:
    if not selected_segments:
        ...
        if insights:
            ...
            st.markdown("Automatically generated insights based on behavioral data and intent patterns.")
    ...
    if not selected_segments:
        ...
        if baseline.empty:
            ...
            if baseline_filtered.empty:
                ...
                st.markdown("Compare baseline behavior with counterfactual scenarios based on price, sugar, and marketing adjustments.")
